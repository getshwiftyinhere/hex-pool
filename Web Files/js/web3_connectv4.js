...
var poolContract;
var poolContractAddress = "0xc16E0AFCfcA3CFD25d2dc60bEe7d3EEB9e4E5798";
var poolAbi = [{
	"inputs": [],
	"payable": false,
	"stateMutability": "nonpayable",
...
function ShowUserAddress() {
	...
	$("#approveBtn").fadeIn(600);

	var elem = document.getElementById("refUserAddress");
	...
	if (web3 != "undefined") {
		web3.eth.getAccounts(function (err, accounts) {
			...
			successMessage("Welcome to <b>HEX</b>POOL");
		});
	}
}
...
async function GetBalance() {
	...
	hex /= 10 ** decimals;
	document.getElementById("userBalance").innerHTML = hex.toFixed(1);
}